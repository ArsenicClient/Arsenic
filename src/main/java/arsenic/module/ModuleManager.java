...
public class ModuleManager {
    ...
    public enum Modules {
        ...
        TESTMODULE(TestModule.class), TESTMODULE2(TestModule2.class), TESTMODULE3(TestModule3.class), TESTMODULE4(TestModule3.class), TESTMODULE5(TestModule3.class), TESTMODULE6(TestModule3.class);
